(function($) {
    window.remoteAddress = 'http://ucmwebrtc.ipvideotalk.com';
    ...
    GSWebRTC.prototype = {
        init: function() {
            ...
            var imagePath = remoteAddress + '/anonymousWebRTC/webRTC/images/',
                anonymousWebRTCSS = '<style id="css-anonymousWebRTC" type="text/css">' +
                    ...
                    '#anonymousWebRTC .btn.btn-narrow{ background-image: url("' + imagePath + 'large.png");}' +
                    '#anonymousWebRTC .btn.btn-narrow:hover{ background-image: url("' + imagePath + 'large_hover.png");}' +
                    '#anonymousWebRTC .btn.btn-narrow:focus{ background-image: url("' + imagePath + 'large_pressed.png");}' +
                    '#anonymousWebRTC .btn.btn-large{ background-image: url("' + imagePath + 'large.png");}' +
                    '#anonymousWebRTC .btn.btn-large:hover{ background-image: url("' + imagePath + 'large_hover.png");}' +
                    '#anonymousWebRTC .btn.btn-large:focus{ background-image: url("' + imagePath + 'large_pressed.png");}' +
                    '#anonymousWebRTC .btn.btn-maxsize{ background-image: url("' + imagePath + 'maxsize.png");}' +
                    '#anonymousWebRTC .btn.btn-maxsize:hover{ background-image: url("' + imagePath + 'maxsize_hover.png");}' +
                    '#anonymousWebRTC .btn.btn-maxsize:focus{ background-image: url("' + imagePath + 'maxsize_pressed.png");}' +
                    '#anonymousWebRTC .btn.btn-minisize{ background-image: url("' + imagePath + 'minisize.png");}' +
                    '#anonymousWebRTC .btn.btn-minisize:hover{ background-image: url("' + imagePath + 'minisize_hover.png");}' +
                    '#anonymousWebRTC .btn.btn-minisize:focus{ background-image: url("' + imagePath + 'minisize_pressed.png");}' +
                    '#anonymousWebRTC .btn.btn-close{background-image: url("' + imagePath + 'close.png");}' +
                    '#anonymousWebRTC .btn.btn-close:hover{background-image: url("' + imagePath + 'close_hover.png");}' +
                    '#anonymousWebRTC .btn.btn-close:focus{background-image: url("' + imagePath + 'close_pressed.png");}' +
                    '</style>';
        ...
        render: function() {
            ...
            $("<iframe>").attr({
                ...
                marginheight: "0",
                frameborder: "0",
                src: remoteAddress + "/anonymousWebRTC/webRTC.html"
            }).appendTo(anonymousWebRTC);
            ...
            minisizeBtn.click(function(event) {
                ...
                var WebRTCFrame = window.frames["frameDialog"],
                    domOperation = {
                        operation: ''
                    };
                ...
                if (!flag) {
                    ...
                    domOperation.operation = '$("#callStatus").css("top", "200px");' +
						'$("#divVideoLocal").removeClass("previewvideo-large");'
                    // $("#divVideo", mWindow.document).attr("height", "100%").removeAttr("width");
                    WebRTCFrame.postMessage(JSON.stringify(domOperation), '*');
                    ...
                    domOperation.operation = '$("#callStatus").css("top", "300px")';
