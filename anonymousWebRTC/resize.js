var isIE = (document.all) ? true : false;
    ...
    Resize.prototype = {
        ...
        initialize: function(obj, options) {
            ...
            this._styleWidth = this._styleHeight = this._styleLeft = this._styleTop = 0; //?¨´¨º?2?¨ºy
            this._sideRight = this._sideDown = this._sideLeft = this._sideUp = 0; //¡Á?¡À¨º2?¨ºy
            this._fixLeft = this._fixTop = 0; //?¡§??2?¨ºy
            this._scaleLeft = this._scaleTop = 0; //?¡§??¡Á?¡À¨º

            this._mxSet = function() {}; //¡¤??¡ì¨¦¨¨??3¨¬D¨°
            this._mxRightWidth = this._mxDownHeight = this._mxUpHeight = this._mxLeftWidth = 0; //¡¤??¡ì2?¨ºy
            this._mxScaleWidth = this._mxScaleHeight = 0; //¡À¨¨¨¤y¡¤??¡ì2?¨ºy

            this._fun = function() {}; //??¡¤??¡äDD3¨¬D¨°
        ...
        SetOptions: function(options) {
            this.options = { //??¨¨??¦Ì
                Max: false, //¨º?¡¤?¨¦¨¨??¡¤??¡ì?T??(?atrue¨º¡À????mx2?¨ºy¨®D¨®?)
                mxContainer: "", //???¡§?T???¨²¨¨Y?¡Â?¨²
                mxLeft: 0, //¡Á¨®¡À??T??
                mxRight: 9999, //¨®¨°¡À??T??
                mxTop: 0, //¨¦?¡À??T??
                mxBottom: 9999, //??¡À??T??
                Min: false, //¨º?¡¤?¡Á?D??¨ª???T??(?atrue¨º¡À????min2?¨ºy¨®D¨®?)
                minWidth: 50, //¡Á?D??¨ª?¨¨
                minHeight: 50, //¡Á?D????¨¨
                Scale: false, //¨º?¡¤?¡ã¡ä¡À¨¨¨¤y??¡¤?
                Ratio: 0, //??¡¤?¡À¨¨¨¤y(?¨ª/??)
                onResize: function() {} //??¡¤?¨º¡À?¡äDD
            };
        ...
        Start: function(e, fun, touch) {
            ...
            //mousemove¨º¡À??¡¤? mouseup¨º¡À¨ª¡ê?1
