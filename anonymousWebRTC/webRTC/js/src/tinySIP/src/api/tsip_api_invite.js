...
tsip_session_invite.prototype.start_bfcp_share = function() {
    ...
    switch (this.media.e_type) {
        case tmedia_type_e.AUDIO:
            e_new_media = tmedia_type_e.AUDIO_BFCPVIDEO;
            break;
        case tmedia_type_e.VIDEO:
            e_new_media = tmedia_type_e.VIDEO_BFCPVIDEO;
            break;
        default:
            e_new_media = tmedia_type_e.AUDIO_VIDEO_BFCPVIDEO;
            break;
    }
...
tsip_session_invite.prototype.stop_bfcp_share = function() {
    ...
    switch (this.media.e_type) {
        case tmedia_type_e.AUDIO_BFCPVIDEO:
            e_new_media = tmedia_type_e.AUDIO;
            break;
        case tmedia_type_e.VIDEO_BFCPVIDEO:
            e_new_media = tmedia_type_e.VIDEO;
            break;
        default:
            e_new_media = tmedia_type_e.AUDIO_VIDEO;
            break;
    }
    return this.call(e_new_media);
}
